...
import com.raza.departmentservice.exception.ResourceNotFoundException;
...
public class DepartmentServiceImpl implements DepartmentService {
	...
	public List<DepartmentDto> getByDepartmentCode(String code) {
		List<DepartmentDto> departments = this
				.createDepartmentDtoList(this.departmentRepository.getByDepartmentCode(code));
		if (Objects.isNull(departments)) {
			throw new ResourceNotFoundException("CAN_FOUND_DEPARTMENT_FRO_CODE : " + code);
		}
		return departments;
	}
}
